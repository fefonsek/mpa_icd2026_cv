...
# 7. Comentário
cat(
  "A estimativa de Monte Carlo é próxima do valor obtido por integrate().
Diferenças ocorrem devido à variabilidade amostral do método Monte Carlo.
Com aumento de N, espera-se redução do erro."
)
